...
const kaitime = moment.tz('Asia/Aden').format('HH:mm:ss');
const kaidate = moment.tz('Asia/Aden').format('DD/MM/YYYY');
const time2 = moment().tz('Asia/Aden').format('HH:mm:ss');
...
const time = moment.tz('Asia/Aden').format('DD/MM HH:mm:ss')
const ucap = moment(Date.now()).tz('Asia/Aden').locale('id').format('a')
  ...
  *Response Speed*: ${latensie.toFixed(4)} seconds
  ...
  Type *surrender* to surrender and admit defeat...`
      ...
      */
      ...
      case 'ghstalk': case 'githubstalk': case 'github': {
        ...
        if (!q) return reply(`Give me a user name like *${prefix} HunterBot*`)
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'listpc': {
        ...
        for (let i of anu) {
          teks += `\n\nProfile : @${i.id.split('@')[0]}\nChat : ${i.unreadCount}\nLastchat : ${moment(i.conversationTimestamp * 1000).tz("Asia/Aden").format("DD/MM/YYYY HH:mm:ss")}`
        }
      ...
      case 'listgc': {
        ...
        for (let i of anu) {
          ...
          teks += `\n\nName : ${metadata.subject ? metadata.subject : "undefined"}\nOwner : ${loldd ? '@' + loldd.split("@")[0] : "undefined"}\nID : ${metadata.id ? metadata.id : "undefined"}\nMade : ${metadata.creation ? moment(metadata.creation * 1000).tz('Asia/Aden').format('DD/MM/YYYY HH:mm:ss') : "undefined"}\nMember : ${metadata.participants.length ? metadata.participants.length : "undefined"}`
        }
        A17.sendTextWithMentions(m.chat, teks, m)
      }
        break;
...
*Message : ${text}*\n\n`
        ...
        for (let i = 0; i < randomxx; i++) {
          ...
          try {
            ...
            if (anu1 == '401' || anu1.status.length == 0) {
              ...
              nomerny += `🪄 *Number:* wa.me/${anu[0].jid.split("@")[0]}\n🔹 *Bio :* ${anu1.status}\n🔸 *Updated On :* ${moment(anu1.setAt).tz('Asia/Aden').format('HH:mm:ss DD/MM/YYYY')}\n\n`
            }
          } catch {
      ...
      */
      ...
      case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
        ...
        A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by A17 Bot by HunterBot...  🪄` }, { quoted: m })
      }
      ...
      case 'translate': case 'ts': case 'trans': {
        ...
        tes = await fetchJson(`https://libretranslate.com/translate${args.join(" ")}`)
        Infoo = tes.info
        Detek = tes.translate
      ...
      case 'apod': {
        ...
        const timeZone = 'Asia/Aden'; // Set desired timezone.
      ...
      case 'earthquake':
        ...
        var { Time, Lintang, Longitude, Magnitude, Depth, region, Map } = tres.result
        console.log(Map)
        const captt = `Time : ${Time}\nLatitude : ${Longitude}\nLongitude : ${Longitude}\nRegion : ${region}`
...
{buttonId: `${prefix}qr`, buttonText: {displayText: `Tap to Re-run Repl`}, type: 1}
      ...
      case 'weather':
        ...
        myweather = await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${args.join(" ")}&units=metric&appid=e409825a497a0c894d2dd975542234b0&language=en`)
