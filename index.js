...
async function startA17() {
  console.log(
    color(
      figlet.textSync("Hunter X Bot MD", {
        font: "Standard",
  ...
  console.log(color('\nHello, I am Yousef, the Developer of this bot.\n\nThanks for using: Hunter X Bot.', 'aqua'))
 ...
 */
  ...
  I am *Hunter X Yousef's Bot*, Welcome to ${metadata.subject}.
